...
const JoinMeetingPage = ({ meetingLink }) => {
                    ...
                    <div className="lg:w-1/4 pt-2">
                        ...
                        <div className="flex items-center space-x-3 p-3 rounded-lg bg-gray-700/50">
                            <img
                                ...
                                alt={MEETING_INFO.interviewer}
                                className="w-10 h-10 rounded-full object-cover"
                            />
                            <div>
                                <p className="font-medium text-sm">{MEETING_INFO.interviewer}</p>
                                <p className="text-xs text-gray-400">{MEETING_INFO.interviewerRole}</p>
                            </div>
                        </div>
                    </div>
                </div>
